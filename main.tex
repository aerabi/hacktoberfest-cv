...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{Introduce a \href{https://en.wikipedia.org/wiki/MEAN_(solution_stack)}{MEAN} backend with TypeScript to replace the legacy PHP code. Introduce git, GitLab, Docker, RxJS, CI, local NPM registries. Introduce REST API, TDD, code reviews, dozens of CI jobs, hiring processes like code challenges. Develop compliance and escalation. Manage a small team.\\
