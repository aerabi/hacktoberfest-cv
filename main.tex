...
\maintitle{Mohammad-Ali ~A\textquotesingle{}R\^ABI\footnote{Officially (and ambiguously):\ Mohammad Ali ~ARABI.  Lastname:\ A'R\^ABI \textipa{[æPr6:bi]} means nomad.}}{29. 04. 1991 \ \ \ \ Tehran}{Last update on \today~(v2.2.0)}
...
\begin{itemize}
    \item More than \textbf{8} years of professional experience:
      ...
      \colorsquare{camouflagegreen} 2y \\
        using various languages: TypeScript, Python, Java, Go, JavaScript, PHP, Scala, Coq, R, C, Rust, etc.
...
\headedsection
  {\href{https://www.apptec360.com/}{\colorsquare{orange} Jodel}}
  ...
  \headedsubsection
    ...
    \end{tabular} \\
    \#Kubernetes \#Terraform \#AWS \#MongoDB \#Postgres \#Redis \#Elastic \#Helm \#TypeScript \#Python}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    \end{tabular} \\
    \#MongoDB \#Express.js \#Angular \#Node.js \#TypeScript \#Python \#Mongoose \#Docker \#MariaDB}}
}
