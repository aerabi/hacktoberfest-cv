...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{Introduce a \href{https://en.wikipedia.org/wiki/MEAN_(solution_stack)}{MEAN}\footnote{MongoDB, Express.js, Angular, Node.js. We used them with Mongoose, TSOA, OpenAPI, and TypeScript.} backend with TypeScript to replace the legacy PHP code. Introduce git, GitLab, Docker, RxJS, CI, local NPM registries. Introduce REST API, TDD, code reviews, dozens of CI jobs, hiring processes like code challenges. Improve the product's architecture. Manage a small team.\\
    \faTrophy~Improved company's processes and culture so that it can grow and people can work more efficiently.}}
}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    ...
    \faTrophy~Saved HR team weeks of manual labor by automating the 360$^{\circ}$ feedback and contract generation.}}
}
