...
\chronoperiode[color=frenchblue]{2019}{2021}{AppTec}
\stopchronology
...
\headedsection
  ...
  \headedsubsection
    ...
    {Aug \apo19 -- Present}
    {\bodytext{Introduce a new backend with Node.js, TypeScript, and MongoDB, and a new frontend with Angular. Introduce GitLab, Docker, RxJS, CI, local NPM registries. Coaching. Doing interviews.}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {Jun \apo18 -- Jul \apo19}
    {\bodytext{Implement new features for the cross-product platform team in Java 11. Fixing bugs. Refactoring. Reviewing candidates' assignments. \#MongoDB \#RabbitMQ \#Docker \#RxJava}}
}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {Feb \apo17 -- Jul \apo18}
    {\bodytext{Implement a \href{https://mitpress.mit.edu/sites/default/files/titles/content/9780262162289_sch_0001.pdf}{linear lambda calculus} in Coq and prove its soundness: \href{https://github.com/aerabi/llc}{\texttt{github.com/aerabi/llc}}}}
}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    ...
    {Aug \apo15 -- Sep \apo16}
    {\bodytext{Develop features on \href{https://en.wikipedia.org/wiki/Divar_(website)}{Divar} (10th most used website in Iran) and CafeBazaar (Android app store). Creating CI pipelines. Developing tools for HR. \#Django \#PostgreSQL \#Docker \#GitLab-CI}}
}
...
\headedsection
  ...
  \headedsubsection
    {Java Developer}
    {Sep \apo13 -- Sep \apo15}
    {\bodytext{Creat a distributed platform based on Apache Storm and Hadoop for realtime machine learning.}}
}
