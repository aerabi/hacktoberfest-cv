...
\headedsection
  ...
  \headedsubsection
    ...
    {Aug \apo19 -- Present}
    {\bodytext{Introduce a new backend in Node.js, TypeScript, and MongoDB, and a new frontend in Angular. Introduce git, GitLab, Docker, RxJS, CI, local NPM registries. Manage a small team.}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {Jun \apo18 -- Jul \apo19}
    {\bodytext{Implement new features for the cross-product platform team in Java 11. Fix bugs. Refactor. Review candidates' assignments. \#MongoDB \#RabbitMQ \#Docker \#RxJava}}
}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    ...
    {Aug \apo15 -- Sep \apo16}
    {\bodytext{Develop features on \href{https://en.wikipedia.org/wiki/Divar_(website)}{Divar} (10th most used website in Iran) and CafeBazaar (Android app store). Creat CI pipelines. Develop tools for HR. \#Django \#PostgreSQL \#Docker \#GitLab-CI}}
}
...
\headedsection
  ...
  \headedsubsection
    {Java Developer}
    {Sep \apo13 -- Sep \apo15}
    {\bodytext{Creat a distributed platform based on Apache Storm and Hadoop for real-time machine learning.}}
}
